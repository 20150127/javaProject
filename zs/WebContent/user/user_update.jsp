...
--%>
	...
	<body>
		<form name="myform" method="post"
			action="<%=path%>/us/update.action" enctype="multipart/form-data"
...
<table width="1000px" height="1196" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="table" align="center">
				<tr>
					<td height="1196" align="center" valign="top">
						<table align="center" class="table" border="1" cellpadding="0" cellspacing="0" width="100%" height="301" style="border-collapse: collapse;">
							<tr>
								<td height="288" align="center" valign="top" class="content_L">
									<fieldset>
										...
										<table width="744" height="271" border="0" cellpadding="0"
											...
											<tr>
												...
												<td width="26%" rowspan="5" align="center" valign="middle" class="content_L">
													<table width="140" height="150" border="1" cellpadding="0"
														...
														<tr>
															...
															<td width="138" height="150" align="center"
																...
																<img
																	src="<%=path%>/upload/${o.examineeNum}.jpg" id="img" name="img" width="120" height="150">
											...
											<tr>
												...
												<td height="30" align="left" class="content_L" colspan="2">
											...
											<tr>
												...
												<td height="30" colspan="2" align="left" class="content_L">
													...
													<input name="o.IDCardNum" type="text" id="IDCardNum"
													 ...
													 -->
													${o.IDCardNum }
													<span class="style1">** 身份证号作为报名注册的账号,不能再修改!! </span>
												</td>
											</tr>
											<tr>
												<td height="30" align="right" class="title">
