...
<html>
	...
	<body class="middlebody">
		<form action="<%=path%>/kslq/export.action" method="post"
			...
			<table border="1" cellspacing="0" cellpadding="0" align="center"
				...
				<tr>
					...
					<td width="25%" class="content_L">
						<input type="checkbox" name="properties" value="笔试成绩"
				...
				<tr>
					<td width="25%" class="content_L">
						<input type="checkbox" name="properties" value="会考成绩"
							checked="checked" id="f">
						<label for="f">
							会考成绩
					...
					<td width="25%" class="content_L">
						<input type="checkbox" name="properties" value="特长成绩"
							checked="checked" id="e">
						<label for="e">
							特长成绩
						</label>
				...
				<tr>
					<td width="25%" class="content_L">
						<input type="checkbox" name="properties" value="测试成绩"
							checked="checked" id="f">
						<label for="f">
							测试成绩
						</label>
					...
					<td width="25%" class="content_L">
						<input type="checkbox" name="properties" value="总分"
							checked="checked" id="d">
						<label for="d">
							总分
						</label>
