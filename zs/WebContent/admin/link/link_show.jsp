...
<head>
	...
	<body class="middlebody">
		<form  name="myform"  method="post" action="<%=request.getContextPath() %>/link/update.action">
			<input name="link.id" type="hidden" value="${link.id}">
			<table align="center" class="table" border="1" width="100%"
				...
				<tr>
					<td class="edit_Title">
						...
						<font style="font-weight:bold;font-size:13">报考指南详细</font>
					</td>
					<td class="edit_Title" align="right" width="50%">
					<c:if test="${xy:hasPermission(user.id,'link',2)}">
			...
			<table align="center" class="table" border="1" width="100%"
				...
				<tr>
					...
					<td class="content_L" width="60%">
						<input type="text"  name="link.pxh" id="pxh" value="${link.pxh }" maxlength="40" style="width:95%" class="f_input"  title="排序号">
						<br>
				...
				<tr>
					...
					<td class="content_L" width="60%">
						<input type="text"  name="link.title" id="title" value="${link.title }" maxlength="40" style="width:95%" class="f_input" title="名称">
						<br>
				...
				<tr>
					...
					<td class="content_L" width="60%">
						<input type="text"  name="link.path" id="path" value="${link.path }" maxlength="100" style="width:95%" class="f_input" title="链接网址">
						<br>
				...
				<tr>
					...
					<td class="content_L" width="80%" colspan="3">
						<textarea  name="link.remark" style="width:95%" id="remark" onblur="check()" class="f_textarea" rows="5" cols="20" title="备注">${link.remark }</textarea>
