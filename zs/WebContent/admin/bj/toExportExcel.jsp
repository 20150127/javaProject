...
<html>
	...
	<body class="middlebody">
		<form action="<%=path%>/bj/export.action" method="post"
			...
			<table border="1" cellspacing="0" cellpadding="0" align="center"
				...
				<tr>
					...
					<td width="25%" class="content_L">
						<input type="checkbox" name="properties" value="语文成绩"
				...
				<tr>
					<td width="25%" class="content_L">
						<input type="checkbox" name="properties" value="数学成绩"
					...
					<td width="25%" class="content_L">
						<input type="checkbox" name="properties" value="英语成绩"
