...
<head>
	...
	<body>
		<form  method="post" action="<%=request.getContextPath() %>/domain/addValue.action" onsubmit="return checkForm();">
			<table align="center" class="table" border="1" width="100%" style="border-collapse:collapse;">
				<tr>
					<td class="edit_Title">
						...
						<font style="font-weight:bold;font-size:12px;">新添域值</font>
					</td>
					<td align="right" width="50%">
					<c:if test="${xy:hasPermission(user.id,'domain',0)}">
						<input type="submit" id="MLKZ_BaoCun" name="MLKZ_BaoCun" class="f_btn01"  value="保存">
					</c:if>	
					<input type="hidden" name="domainValue.domain.id" value="${domain.id }">
			...
			<table align="center" class="table" border="1" width="100%" style="border-collapse:collapse;">
				<tr>
					...
					<td class="content_L" width="60%">
						<input type="text"  name="domainValue.valueName" id="valueName" maxlength="30" style="width:95%" class="f_input" title="域值"><font  color="red" title="必填项">*</font><br>
				...
				<tr>
					...
					<td class="content_L"  width="60%">
						<textarea  name="domainValue.remark" style="width:95%" id="remark" onblur="check()" class="f_textarea" rows="5" cols="50"></textarea><br>
