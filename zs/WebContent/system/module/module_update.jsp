...
<head>
	...
	<body>
		<form  name="myform"  method="post" action="<%=request.getContextPath()%>/module/update.action" >
			<table align="center" class="table" border="1" width="100%" style="border-collapse:collapse;">
				<tr>
					<td class="edit_Title" >
						...
						<font style="font-weight:bold;font-size:13">模块修改</font>
					</td>
					<td align="right" class="edit_Title">
			...
			<table align="center" class="table" border="1" width="100%" style="border-collapse:collapse;">
				<tr>
					...
					<td class="content_L" width="60%">
						<input type="text"  name="sysModule.sysModuleName" id="moduleName"  value="${module.sysModuleName}" maxlength="10" style="width:95%" class="f_input"><input type="hidden"  name="sysModule.id"  value="${module.id}"><input type="hidden"  name="sysModule.sysLevel"  value="${module.sysLevel}"><input type="hidden"  name="sysModule.isLeaf"  value="${module.isLeaf}"><font  color="red" title="必填项">*</font><br>
						只允许填写中文、和英文字母<br>
				...
				<tr>
					...
					<td class="content_L" width="60%">
						<input type="text"  name="sysModule.sn" id="sn" readonly maxlength="10" value="${module.sn}" style="width:95%" class="f_input"><font  color="red" title="必填项">*</font><br>
						只允许填写英文字母和数字<br>
					...
					<tr>
						...
						<td class="content_L" width="60%">
							<input type="text"  readonly  id="pmoduleName" name="sysModule.parentModule.sysModuleName" value="${module.parentModule.sysModuleName}" readonly maxlength="10" style="width:95%"  class="f_input"><input type="hidden"  value="${module.parentModule.id}" name="sysModule.parentModule.id" id="moduleId">
							<font  color="red" title="必填项">*</font>
				...
				<tr>
					...
					<td class="content_L" width="60%">
						<input type="text"  name="sysModule.orderId" id="orderId" value="${module.orderId}" maxlength="10" style="width:95%" class="f_input"><font  color="red" title="必填项">*</font><br>
						同一层次的排列顺序（阿拉伯数字）<br>
				...
				<tr>
					...
					<td class="content_L"  width="60%">
						<textarea  name="sysModule.remark" style="width:95%" id="remark" onblur="check()" class="f_textarea" rows="5" cols="50">${module.remark}</textarea><br>
