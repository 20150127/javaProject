...
public class FSAction extends BaseAction {
	...
	public String list(){
	    ...
	    hql.append(" order by s.specialtyId.id asc , s.fushicj desc");
	...
	public HSSFWorkbook exportExcel(List dataList, String[] headers)
		...
		try {
			...
			HSSFSheet sheet = workbook.createSheet("FS");
